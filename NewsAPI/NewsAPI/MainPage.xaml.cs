...
namespace NewsAPI
{
    public partial class MainPage : ContentPage
    {
        ...
        public static string UrlSortedByCategory = $"https://newsapi.org/v2/everything?apiKey=b8cc28acb3634fcc937daae3b28872a4&language=ru";
        public static string UrlSortedByDate = $"https://newsapi.org/v2/top-headlines?apiKey=b8cc28acb3634fcc937daae3b28872a4&language=ru";

        public static string PATH = System.IO.Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "articles.json");
        public bool SortByDate = true;
        public string Title = "";
        public string Sort = "popularity"; // publishedAt
        public string Category;
        public string From = "";
        public DateTime DateFrom = DateTime.MinValue; //DateTime.MinValue; 
